...
extension CellNode {
    override func layoutSpecThatFits(_ constrainedSize: ASSizeRange) -> ASLayoutSpec {
        ...
        return ASInsetLayoutSpec(insets: .init(top: 0, left: 0, bottom: 0, right: 0), child: cell)
    }
    ...
    private func cellLayoutSpec(_ constrainedSize: ASSizeRange) -> ASLayoutSpec {
      ...
      let cellLayout = ASStackLayoutSpec(direction: .horizontal, spacing: 10, justifyContent: .start, alignItems: .center, children: [profileImageLayout, userNameWithMessageLayout])
